    ...
    <div class="invoice-box" style="margin-left: auto; margin-right: auto; display: block;">
        ...
        <div style="margin-top: 20px; margin-bottom: 20px;">
            ...
            <div class="welcome-desc" style="border:5px">
                <p>ระบบ <span style="color: green;">อนุมัติการจอง</span></p>
                <p>สามารถเข้าใช้งานได้ตามวันเวลาที่จองห้องประชุม ขอขอบคุณสำหรับการใช้งานระบบการลงทะเบียนจองห้องประชุม(TIJ)</p>
            </div>
        </div>
        <hr>
