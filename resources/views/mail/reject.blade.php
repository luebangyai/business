    ...
    <div class="invoice-box" style="margin-left: auto; margin-right: auto; display: block;">
        ...
        <div style="margin-top: 20px; margin-bottom: 20px;">
            ...
            <div class="welcome-desc" style="border:5px">
                <p>ระบบ <span style="color: red;">ไม่อนุมัติการจอง</span></p>
                <p>วันเวลาที่ท่านเลือกไม่สามารถเข้าใช้งานห้องประชุมได้ ขอขอบคุณสำหรับการใช้งานระบบการลงทะเบียนจองห้องประชุม(TIJ)</p>
            </div>
        </div>
        <hr>
